#! /system/bin/sh
#ifdef VENDOR_EDIT
#JianRong.Zheng@Swdp.Android.EngineeringMode, 2016/12/06, Modify for customized ap ssid, ip address
#rssi_threshold=-40
#meta_ssid="wifimetatest"
#static_ip="192.168.43.108"
#router_ap_ip="192.168.43.1"
#scan_para="TYPE=ONLY freq=2437"
#conn_para="freq=2437"
# 2437-channel 6
#else
rssi_threshold=-45
meta_ssid="TE-NonSignal"
static_ip="181.157.1.101"
router_ap_ip="181.157.1.1"
scan_para="TYPE=ONLY freq=2462"
conn_para="freq=2462"
# 2462-channel 11
#endif
